...
\begin{frame}[fragile]{Attacker Profile ii}
    ...
    \begin{figure}
      \centering
      \subfloat[Operators working hours\label{fig:a}]{\includegraphics[height=3.5cm,width=5.5cm]{figures/attacker_timeline.PNG}}\qquad
      \subfloat[Distribution of the backdoor commands used by the operators\label{fig:b}]{\includegraphics[height=3.2cm,width=4.4cm]{figures/commands_distrib.PNG}}
    \end{figure}
\end{frame}
