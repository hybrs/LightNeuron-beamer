...
\begin{frame}[fragile]{Attacker Profile condt}
    ...
    \begin{figure}
      ...
      \subfloat[Distribution of the backdoor commands used by the operators\label{fig:b}]{\includegraphics[height=3.6cm,width=4.4cm]{figures/commands_distrib.PNG}}
    \end{figure}
\end{frame}
